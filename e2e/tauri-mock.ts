...
export async function installTauriMock(page: Page): Promise<void> {
  await page.addInitScript(() => {
    ...
    > = {
      ...
      get_environments: () => [],
      get_projects_cmd: () => [],
      save_project_cmd: () => null,
      delete_project_cmd: () => null,
      get_app_setting_cmd: () => null,
      set_app_setting_cmd: () => null,
      list_secure_token_environments_cmd: () => [],
      has_secure_token_cmd: () => false,
      save_secure_token: () => null,
      delete_secure_token_cmd: () => null,
      copy_secure_token_cmd: () => null,
